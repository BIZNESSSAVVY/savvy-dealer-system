...
import dealershipImage from "@/images/dealership.png";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-automotive-gold">
              Savvy Dealer Platform Demo
            </span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A complete demo showcasing a modern dealership's digital presence
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative group animate-slide-up">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-premium border-2 border-automotive-gold/20">
              <img
                src={dealershipImage}
                alt="Savvy Dealer Platform Interface Demo"
          ...
          <div className="space-y-6 animate-scale-in">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="text-center p-4 bg-card rounded-xl border border-border hover:border-automotive-gold transition-colors duration-300">
                ...
                <p className="text-sm font-semibold text-foreground">Smart Tools</p>
              </div>
              <div className="text-center p-4 bg-card rounded-xl border border-border hover:border-automotive-gold transition-colors duration-300">
              ...
              <div className="text-center p-4 bg-card rounded-xl border border-border hover:border-automotive-gold transition-colors duration-300">
                ...
                <p className="text-sm font-semibold text-foreground">Digital Workflow</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-primary/5 to-automotive-gold/5 rounded-xl p-6 border border-automotive-gold/20">
              <p className="text-foreground text-lg leading-relaxed mb-6">
                This demo showcases the full power of the Savvy Dealer platform — 
                featuring live inventory management, customer financing applications, 
                and automated communication tools designed for modern dealerships.
              </p>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-muted-foreground">
                  ...
                  <span>Demo Location: Main Office</span>
                </div>
                <div className="flex items-center text-muted-foreground">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
          <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-automotive-gold/10 rounded-xl border border-automotive-gold/30">
            <p className="text-3xl font-bold text-primary mb-2">Intuitive</p>
            <p className="text-muted-foreground">Dealer Dashboard</p>
          </div>
          <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-automotive-gold/10 rounded-xl border border-automotive-gold/30">
            <p className="text-3xl font-bold text-primary mb-2">Integrated</p>
            <p className="text-muted-foreground">Customer Tools</p>
          </div>
          <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-automotive-gold/10 rounded-xl border border-automotive-gold/30">
            <p className="text-3xl font-bold text-primary mb-2">Scalable</p>
            <p className="text-muted-foreground">Platform Architecture</p>
          </div>
        </div>
      </div>
    </section>
