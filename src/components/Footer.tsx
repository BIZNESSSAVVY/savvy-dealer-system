...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-background to-muted/50 border-t border-border shadow-md">
      ...
      {/* Bottom Gradient Bar */}
      <div className="bg-gradient-primary text-center py-3 text-sm font-medium text-automotive-gold shadow-inner">
        Powered by{" "}
        <a
          href="https://savvyordersystems.com"
          target="_blank"
          rel="noopener noreferrer"
          className="text-white hover:text-automotive-gold transition-colors font-semibold"
        >
          Savvy OS
        </a>
      </div>
